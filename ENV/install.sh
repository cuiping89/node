...
<style>
        ...
        * { box-sizing: border-box; }
        ...
        .card h3 {
            ...
            font-size: 1.25rem;  /* 一级标题最大 */
            font-weight: 700;    /* 一级标题最粗 */
            color: #1e293b;      /* 一级标题最深 */
            display: flex;
        ...
        .info-block h4 {
            margin: 0 0 8px 0;
            font-size: 1rem;     /* 二级标题中等 */
            font-weight: 600;    /* 二级标题中等加粗 */
            color: #374151;      /* 二级标题中等颜色 */
        }
        ...
        .progress-budget {
            color: #64748b;      /* 三级统一颜色 */
            font-size: .875rem;  /* 三级统一字号 */
            font-weight: 400;    /* 三级统一字重 */
        }
