...
readonly EB_INSTALL_DIR="/etc/edgebox"
readonly EB_CONFIG_DIR="${EB_INSTALL_DIR}/config"
readonly EB_CERT_DIR="${EB_INSTALL_DIR}/cert"
readonly EB_TRAFFIC_DIR="${EB_INSTALL_DIR}/traffic"
readonly EB_SCRIPTS_DIR="${EB_INSTALL_DIR}/scripts"
readonly EB_TEMPLATES_DIR="${EB_INSTALL_DIR}/templates"
readonly EB_BACKUP_DIR="/root/edgebox-backup"

# Configuration files
readonly EB_SERVER_JSON="${EB_CONFIG_DIR}/server.json"
readonly EB_XRAY_JSON="${EB_CONFIG_DIR}/xray.json"
readonly EB_SINGBOX_JSON="${EB_CONFIG_DIR}/sing-box.json"
readonly EB_CERT_MODE_FILE="${EB_CONFIG_DIR}/cert_mode"

# Web root
readonly EB_WEB_ROOT="/var/www/html"

# Subscription output files (4 formats, written atomically as a set)
readonly EB_SUB_PLAIN="${EB_CONFIG_DIR}/subscription.txt"
readonly EB_SUB_BASE64="${EB_CONFIG_DIR}/subscription.base64"
readonly EB_SUB_CLASH="${EB_CONFIG_DIR}/subscription.clash.yaml"
readonly EB_SUB_SINGBOX="${EB_CONFIG_DIR}/subscription.singbox.json"

# Log files
readonly EB_LOG_FILE="/var/log/edgebox-install.log"

# Version
readonly EB_VERSION="v4.0.0"
