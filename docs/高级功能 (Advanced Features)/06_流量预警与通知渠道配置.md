...
2.  **检查 Discord！** 🎉
    如果一切顺利，您指定的 Discord 频道里会立刻收到一条来自“服务器警报”的测试消息！

恭喜！您的 Discord 流量预警已经配置完毕。当服务器流量达到您设定的阈值时，就会自动发送通知到这个频道了。
